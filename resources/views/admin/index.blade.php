  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        ...
        <a href="{{route('game.adminCreate')}}"><button type="submit" >@lang('Create game')</button> <br> <br></a>
        </div>
    </div>
  </div>
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        ...
        <a href="{{route('article.adminCreate')}}"><button type="submit" >@lang('Create article')</button> <br> <br></a>
      </div>
    </div>
  </div>
</div>

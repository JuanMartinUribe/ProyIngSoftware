    ...
    <div class="col-md-8">
      <div class="card-body">
        ...
        @foreach ($viewData["comments"] as $comment)
          <div class="col-md-5 col-lg-5 mb-2">
            <div class="card">
              ...
              <p>{{$comment->getUser()["name"]}} <br> @lang('Comment'): <br>{{ $comment->getDescription() }} 
        ...
        <form action="{{ route('comment.save')}}" method="post">
               @csrf
              <input type="text" class="form-control mb-2" placeholder= "@lang('Comment here')" name="@lang('Description')" value="{{ old('description') }}" />
